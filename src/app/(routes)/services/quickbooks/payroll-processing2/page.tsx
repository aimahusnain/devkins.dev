...
const PayrollProcessingDetailsPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Detailed Payroll Processing Services | NextGen Financial</title>
        <meta
          name="description"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white rounded-xl shadow-2xl overflow-hidden mb-20">
                <div className="bg-green-600 text-white p-6">
                  ...
                  <h2 className="text-2xl font-bold">Why Choose NextGen Financial for Payroll Processing?</h2>
                </div>
                <div className="p-6">
                  <ul className="space-y-4">
                    {[
